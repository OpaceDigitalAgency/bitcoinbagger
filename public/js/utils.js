...
class Utils {
    ...
    static generateCompanyCard(company) {
        const premiumClass = Utils.getPremiumClass(company.premium);
        return `
            <div class="card fade-in">
                ...
                <div class="card-stats">
                    <div class="card-stat">
                        ...
                        <span class="card-stat-value">${Utils.formatNumber(company.btcHeld)} BTC</span>
                    </div>
                    <div class="card-stat">
                        <span class="card-stat-label">Value:</span>
                        <span class="card-stat-value">${Utils.formatCurrency(company.btcValue)}</span>
                    </div>
                    <div class="card-stat">
                        <span class="card-stat-label">Stock Price:</span>
                        <span class="card-stat-value">${Utils.formatCurrency(company.stockPrice)}</span>
                    </div>
                    <div class="card-stat">
                        <span class="card-stat-label">Premium:</span>
                        <span class="card-stat-value premium ${premiumClass}">${Utils.formatPercentage(company.premium)}</span>
                    </div>
                </div>
            </div>
        `;
    ...
    static generateETFCard(etf) {
        const premiumClass = Utils.getPremiumClass(etf.premiumDiscount);
        return `
            <div class="card fade-in">
                <h3>${etf.name}</h3>
                ...
                <div class="card-stats">
                    <div class="card-stat">
                        <span class="card-stat-label">BTC Holdings:</span>
                        <span class="card-stat-value">${Utils.formatNumber(etf.btcHeld)} BTC</span>
                    </div>
                    <div class="card-stat">
                        <span class="card-stat-label">Price:</span>
                        <span class="card-stat-value">${Utils.formatCurrency(etf.price)}</span>
                    </div>
                    <div class="card-stat">
                    ...
                    <div class="card-stat">
                        <span class="card-stat-label">Premium:</span>
                        <span class="card-stat-value premium ${premiumClass}">${Utils.formatPercentage(etf.premiumDiscount)}</span>
                    </div>
                </div>
            </div>
        `;
